...
class CheckIN:
    ...
    def __init__(self, root):
        ...
        # name label
        self.name_label = Label(self.bottom, font=('arial', 20, 'bold'), text="ENTER YOUR NAME :", fg="#15d3ba", anchor="w")
        ...
        # address label
        self.address_label = Label(self.bottom, font=('arial', 20, 'bold'), text="ENTER YOUR ADDRESS :", fg="#15d3ba", anchor="w")
        ...
        # mobile label
        self.mobile_label = Label(self.bottom, font=('arial', 20, 'bold'), text="ENTER YOUR MOBILE NUMBER :", fg="#15d3ba", anchor="w")
        ...
        self.days_label = Label(self.bottom, font=('arial', 20, 'bold'), text="ENTER NUMBER OF DAYS TO STAY :", fg="#15d3ba", anchor="w")
        ...
        # room number label
        self.room_number_label = Label(self.bottom, font=('arial', 20, 'bold'), text="ROOM NUMBER: ", fg="#15d3ba", anchor="w")
        ...
        def submit_info():
            ...
            if ans == True and ans1 == True:
                ...
                with conn:
                    cursor = conn.cursor()
                cursor.execute('CREATE TABLE IF NOT EXISTS Hotel (Fullname TEXT,Address TEXT,mobile_number NUMBER,number_days NUMBER,room_number NUMBER)')
                ...
                self.days_var.set('')
                self.mobile_var.set('')
                messagebox.showinfo("Success", "Check-in Successful")  # Show success message
            else:
                messagebox.showerror("Error", "Check-in Failed")  # Show error message
        ...
        self.submit_button = Button(self.checkbox, text="SUBMIT", font=('', 15), bg="#15d3ba", relief=RIDGE, height=2, width=15,
                                    fg="black", anchor="center", command=submit_info)
        self.submit_button.grid(row=5, column=1, padx=10, pady=10)

        # back to home page
        self.back_home_button = Button(self.checkbox, text="HOME", font=('', 15), bg="#15d3ba", relief=RIDGE, height=2, width=15,
